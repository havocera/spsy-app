	...
	<view class="wrap">
		<view class="top">
			<view class="item">
				...
				<input type="text" v-model="address.name" placeholder-class="line" placeholder="请填写收货人姓名" />
			</view>
			<view class="item">
		...
		<view class="bottom">
			...
			<view class="default">
				...
				<view class="right"><u-switch v-model="checked" active-color="rgb(16, 203, 132)" :size="size" @change="setDefault"></u-switch></view>
			</view>
		</view>
		<u-picker mode="region" ref="uPicker" v-model="show" />
		<button type="default" @click="saveAddress">保存地址</button>
	</view>
</template>
